...
async function main() {
    program
        .version('0.0.1')
        .description(`transfer on layer2. for example:\nnode ${process.argv[1]} --from Bob --to Alice --amount 100 --nonce 0`)
        ...
        .option('-n, --nonce [nonce]', 'nonce of from user. You can get nonce by "cli/query.js account --name <NAME>"')
        .parse(process.argv)
